...
```
mkdir -p /opt/java
cd ~ && wget http://oos.hongyangliao.com/jdk-8u151-linux-x64.tar.gz
...
#### 安装Tomcat
```
cd ~ && wget http://oos.hongyangliao.com/apache-tomcat-8.5.24.tar.gz
...
##### 下载并安装nginx
```
cd && wget http://oos.hongyangliao.com/nginx-1.8.1.tar.gz
...
#### 安装Redis
```
cd && wget http://oos.hongyangliao.com/redis-4.0.6.tar.gz
...
#### 安装Maven
```
cd ~ && wget http://oos.hongyangliao.com/apache-maven-3.5.2-bin.tar.gz
